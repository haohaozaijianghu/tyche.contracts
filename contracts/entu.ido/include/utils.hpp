...
inline asset calc_coin_quant( const asset &base_quant, const asset &price ) {
...
inline asset calc_asset_quant( const asset &quote_quant, const asset &price, const symbol &base_symbol ) {
