#include <tyche.lock/tyche.lock.hpp>
...
void tyche_lock::init(const name& admin) {
   require_auth( _self );
   _gstate.admin                    = admin;
 ...
 */
void tyche_lock::ontransfer(const name& from, const name& to, const asset& quant, const string& memo) {
