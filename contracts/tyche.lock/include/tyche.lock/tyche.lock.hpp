...
#include <tyche.lock/tyche.lock.db.hpp>
#include <wasm_db.hpp>
namespace tychefi {
 ...
 */
class [[eosio::contract("tyche.lock")]] tyche_lock : public contract {
   public:
      using contract::contract;

   tyche_lock(eosio::name receiver, eosio::name code, datastream<const char*> ds): contract(receiver, code, ds),
