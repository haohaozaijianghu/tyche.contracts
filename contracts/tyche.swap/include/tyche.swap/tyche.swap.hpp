...
#include <tyche.swap/tyche.swap.db.hpp>
#include <wasm_db.hpp>
namespace tychefi {
 ...
 */
class [[eosio::contract("tyche.swap")]] tyche_swap : public contract {
   public:
      using contract::contract;

   tyche_swap(eosio::name receiver, eosio::name code, datastream<const char*> ds): contract(receiver, code, ds),
