...
NTBL("global") global_t {
    ...
    time_point_sec      interest_splitted_at;                               //利息周期结束时间,TODO set
...
//Scope: _self
TBL reward_t {
    asset               total_reward_quant;         //总奖励, PK: symbol
